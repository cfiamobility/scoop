...
public class ProfileCommentAdapter extends RecyclerView.Adapter<ProfileCommentViewHolder>
    ...
    public void onBindViewHolder(@NonNull ProfileCommentViewHolder profileCommentViewHolder, int i) {
        ...
        PostCommentFragment.setDisplayPostListener(profileCommentViewHolder,
                ...
                mProfileCommentPresenter.getReferenceIdByIndex(i), mProfileCommentPresenter.getPosterIdByIndex(i));
        ...
        PostCommentFragment.setPostOptionsListener(profileCommentViewHolder, i,
                mProfileCommentPresenter.getActivityIdByIndex(i),
                mProfileCommentPresenter.getPosterIdByIndex(i), mProfileCommentView);
    }
