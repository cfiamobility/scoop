...
public class ProfileLikes extends ProfileComment {
    /**
     * Data class which stores information for a single profile like.
    ...
    protected ProfileLikes(JSONObject jsonPost, JSONObject jsonImage) {
